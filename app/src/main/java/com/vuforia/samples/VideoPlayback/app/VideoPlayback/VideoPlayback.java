    ...
    SampleApplicationControl, SampleAppMenuInterface
{
    ...
    private static final String kAccessKey = "17871a64b02ac4357fb52860d79818b914a8b927";
    private static final String kSecretKey = "4f301d5632b52e52a459c10e85070de3fa198de9";
    ...
    JSONObject SorteoObject;

    LinearLayout scannerLayout;

    MEDIA_STATE mediaState = MEDIA_STATE.NOT_READY;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mMovieName[STONES] = "http://techslides.com/demos/sample-videos/small.mp4";
    ...
    public boolean doLoadTrackersData()
    {
        ...
        final int statusCode = targetFinder.updateSearchResults();
    ...
    public void onVuforiaUpdate(State state)
    {
        ...
        } else if (statusCode == TargetFinder.UPDATE_RESULTS_AVAILABLE)
        {
            ...
            if (finder.getResultCount() > 0)
            {
                ...
                Log.e("cloud reco : ", "encontrado.");
                String meta = result.getMetaData();
                String name = result.getTargetName();

                String jsondata = meta;
                try {
                    JSONObject jsonMeta = new JSONObject(jsondata);
                    videoUrl = jsonMeta.getString("videoUrl");
                } catch (JSONException e) {
                    e.printStackTrace();
                }

                Log.e("metadata : ",""+meta.toString());

                mRenderer.setMMovieName(name);

                // mVideoPlayerHelper[STONES] = new VideoPlayerHelper();
                mVideoPlayerHelper[STONES].init();
                mVideoPlayerHelper[STONES].unload();
                mVideoPlayerHelper[STONES].load(videoUrl, VideoPlayerHelper.MEDIA_TYPE.ON_TEXTURE_FULLSCREEN,true,-1);
                ...
                //mRenderer.setImageTargetName("stones");
